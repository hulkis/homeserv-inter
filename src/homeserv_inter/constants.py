...
LABEL_COLS += ['INSTANCE_ID', 'INCIDENT_TYPE_ID', 'RESOURCE_ID', 'LOCATION_ID', 'ORGANISATION_ID', 'PARTY_ID_OCC', 'L1_ORGANISATION_ID', 'L2_ORGANISATION_ID', ]
...
CATBOOST_FEATURES = ['INSTANCE_ID', 'INCIDENT_TYPE_ID', 'RESOURCE_ID', 'LOCATION_ID', 'ORGANISATION_ID', 'PARTY_ID_OCC', 'L1_ORGANISATION_ID', 'L2_ORGANISATION_ID', ]
CATBOOST_FEATURES += STR_COLS
