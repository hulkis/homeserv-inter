...
ALL_COLS += ['INCIDENT_TYPE_NAME', 'INCIDENT_STATUS_NAME', 'INCIDENT_STATUS_CODE', 'INCIDENT_CLOSED_FLAG', 'TYPE_BI', 'PROBLEM_CODE', 'ORIGINE_INCIDENT', 'COMMENTAIRE_BI', 'SS_TR_FLAG', 'TYPE_UT', 'GRAVITE', 'COMMENTAIRE_FIN_INTERV', 'MOTIF_ANNULATION_CODE', 'MOTIF_ANNULATION_DESC',]
...
NUMERIC_COLS += ['INSTANCE_ID', 'INCIDENT_NUMBER', 'INCIDENT_TYPE_ID', 'INCIDENT_STATUS_ID', 'NB_PASSAGE', 'MILLESIME', 'PROBLEM_DESC', 'MOTIF_A_REVOIR', 'AUTEUR_INCIDENT', 'RESOURCE_ID', ]
NUMERIC_COLS = list(set(NUMERIC_COLS))

FLOAT_COLS = []
STR_COLS = ['INCIDENT_STATUS_NAME', 'INCIDENT_STATUS_CODE', 'INCIDENT_CLOSED_FLAG', 'MOTIF_ANNULATION_CODE', 'MOTIF_ANNULATION_DESC', "INCIDENT_TYPE_NAME", "TYPE_BI", "PROBLEM_CODE", "PROBLEM_DESC", "ORIGINE_INCIDENT", "COMMENTAIRE_BI", "SS_TR_FLAG", "TYPE_UT", "GRAVITE", "TYPE_OCC", "RACHAT_CODE", "RACHAT_LIB", "NATURE_CODE", "MARQUE_LIB", "MODELE_CODE", "MODELE_LIB", "USAGE_LOCAL", "LOCALISATION_ORGANISME", "COMPLEMENT_RUE", "ESCALIER", "ETAGE", "NUMERO", "RUE", "PAYS", "TYPE_VOIE", "VILLE", "STOP_PHONING", "CODE_GEN_EQUIPEMENT", "CODE_FONCTION", "CODE_INSTALLATION", "CODE_SPECIFICATION", "CODE_EAU_CHAUDE", "L1_NAME", "L2_NAME", "ADRESSE", "L2_ORGA_VILLE", "STS_CODE", "CONTRACT_MODIFICATEUR", "FORMULE", "OPTION", "CONDITION_REGLEMENT", "MOTIF_RESILIATION", "RENOUVELLEMENT_AGENCE", "EAU_CHAUDE", "ENERGIE", "FONCTION", "INSTALLATION", "SPECIFICATION"]
STR_COLS += ['INCIDENT_TYPE_NAME', 'INCIDENT_STATUS_NAME', 'INCIDENT_STATUS_CODE', 'INCIDENT_CLOSED_FLAG', 'TYPE_BI', 'PROBLEM_CODE', 'ORIGINE_INCIDENT', 'COMMENTAIRE_BI', 'SS_TR_FLAG', 'TYPE_UT', 'GRAVITE', 'COMMENTAIRE_FIN_INTERV', 'MOTIF_ANNULATION_CODE', 'MOTIF_ANNULATION_DESC', ]
...
TIMESTAMP_COLS += ['SCHEDULED_START_DATE', 'SCHEDULED_END_DATE', 'ACTUAL_START_DATE', 'ACTUAL_END_DATE', 'CRE_DATE_GZL', 'DATE_SAISIE_RETOUR', ]
TIMESTAMP_COLS = list(set(TIMESTAMP_COLS))

NLP_COLS = ["COMMENTAIRE_BI", "COMMENTAIRE_FIN_INTERV"]
